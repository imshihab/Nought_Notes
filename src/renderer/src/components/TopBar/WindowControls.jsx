...
export default function WindowControls() {
    ...
    return (
        ...
        >
            <button
                className="w-[32px] h-[32px] flex items-center justify-center rounded hover:bg-gray-200"
            ...
            <button
                className="w-[32px] h-[32px] flex items-center justify-center  hover:bg-red-500 hover:text-white rounded"
