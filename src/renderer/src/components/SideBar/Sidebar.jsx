            ...
            <nav className="flex flex-col items-center justify-start w-20 min-w-20 max-w-20 gap-3">
                ...
                <NavItem
                    ...
                    onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        set("isActive", { name: "Archives", uid: "0000000" })
                        navigate("/Archives")
                    }}
                    label="Archives"
                ...
                <NavItem
                    ...
                    onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        set("isActive", { name: "Favorites", uid: "0000000" })
                        navigate("/Favorites")
                    }}
                    label="Favorites"
                ...
                <NavItem
                    ...
                    onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        set("isActive", { name: "Trash", uid: "0000000" })
                        navigate("/Trash")
                    }}
                    label="Trash"
                ...
                <NavItem
                    ...
                    onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        set("isActive", { name: "Hidden", uid: "0000000" })
                        navigate("/Hidden")
                    }}
                    label="Hidden"
